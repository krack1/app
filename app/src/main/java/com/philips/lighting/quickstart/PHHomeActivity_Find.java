 ...
 *
 */
public class PHHomeActivity_Find extends Activity implements OnItemClickListener {
    ...
    private PHSDKListener listener = new PHSDKListener() {
        ...
        public void onAuthenticationRequired(PHAccessPoint accessPoint) {
            ...
            startActivity(new Intent(PHHomeActivity_Find.this, PHPushlinkActivity.class));

        }

        @Override
        public void onConnectionResumed(PHBridge bridge) {
            if (PHHomeActivity_Find.this.isFinishing())
                return;
        ...
        public void onError(int code, final String message) {
            ...
            if (code == PHHueError.NO_CONNECTION) {
                ...
                PHWizardAlertDialog.getInstance().closeProgressDialog();
                PHHomeActivity_Find.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        PHWizardAlertDialog.showErrorDialog(PHHomeActivity_Find.this, message, R.string.btn_ok);
                    }
                });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        PHWizardAlertDialog.getInstance().showProgressDialog(R.string.connecting, PHHomeActivity_Find.this);
        phHueSDK.connect(accessPoint);
    }

    public void doBridgeSearch() {
        PHWizardAlertDialog.getInstance().showProgressDialog(R.string.search_progress, PHHomeActivity_Find.this);
        PHBridgeSearchManager sm = (PHBridgeSearchManager) phHueSDK.getSDKService(PHHueSDK.SEARCH_BRIDGE);
